...
class MysqlProvider {
    ...
    public static function connect(){
        ...
        if($connection){
            ...
            Loader::getInstance()->getLogger()->info(TE::LIGHT_PURPLE."SyferHCF ".TE::GOLD."| ".TE::GREEN."MySQL connected correctly");
        }else{
            Loader::getInstance()->getLogger()->info(TE::LIGHT_PURPLE."SyferHCF ".TE::GOLD."| ".TE::YELLOW."MySQL has not been connected");
        }
    }
