...
use SyferHCF\Task\FreezeTimeTask;
    ...
    public function onPlayerMoveEvent(PlayerMoveEvent $event) : void {
    	...
    	if($player->getRegion() !== $player->getCurrentRegion()){
    		if($player->getCurrentRegion() === "Spawn"){
    			$player->sendMessage(TE::LIGHT_PURPLE."Now Leaving§f » ".TE::RED.$player->getRegion().TE::WHITE." (".TE::RED."Deathban".TE::WHITE.")");
				$player->sendMessage(TE::LIGHT_PURPLE."Now Entering§f » ".TE::RED."Spawn".TE::WHITE." (".TE::GREEN."No-Deathban".TE::WHITE.")");
			}else{ 
				if($player->getRegion() === "Spawn"){
					$player->sendMessage(TE::LIGHT_PURPLE."Now Leaving§f » ".TE::RED."Spawn".TE::WHITE." (".TE::GREEN."No-Deathban".TE::WHITE.")");
					$player->sendMessage(TE::LIGHT_PURPLE."Now Entering§f » ".TE::RED.$player->getCurrentRegion().TE::WHITE." (".TE::RED."Deathban".TE::WHITE.")");
				}else{
					...
					$player->sendMessage(TE::LIGHT_PURPLE."Now Leaving§f » ".$region.TE::WHITE." (".TE::RED."Deathban".TE::WHITE.")");
					$player->sendMessage(TE::LIGHT_PURPLE."Now Entering§f » ".TE::RED.$currentRegion.TE::WHITE." (".TE::RED."Deathban".TE::WHITE.")");
				}
			}
