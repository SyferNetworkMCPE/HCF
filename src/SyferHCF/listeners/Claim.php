...
class Claim implements Listener {
    ...
    public function onPlayerDropItemEvent(PlayerDropItemEvent $event) : void {
        ...
        if($player->isInteract() && $player->getInventory()->getItemInHand()->getCustomName() === TE::LIGHT_PURPLE."Claim Hoe"){
    ...
    public function onPlayerInteractEvent(PlayerInteractEvent $event) : void {
        ...
        if($player->isInteract() && $player->getInventory()->getItemInHand()->getCustomName() === TE::LIGHT_PURPLE."Claim Hoe" && $event->getAction() === PlayerInteractEvent::RIGHT_CLICK_BLOCK){
            $event->setCancelled(true);
            ...
            if(!System::isPosition($player, 1)){
                ...
                Tower::create($block, $player, Block::get(Block::COAL_BLOCK));
    ...
    public function onBlockBreakEvent(BlockBreakEvent $event) : void {
        ...
        if($player->isInteract() && $player->getInventory()->getItemInHand()->getCustomName() === TE::LIGHT_PURPLE."Claim Hoe"){
            ...
            Tower::create($block, $player, Block::get(Block::IRON_BLOCK));
