...
use SyferHCF\Task\event\FFATask;

use pocketmine\event\Listener;

class FFA implements Listener {
	 ...
	 * @param Loader $plugin
	 */
	public function FFA__construct(Loader $plugin){
		$this->plugin = $plugin;
	}
	...
	public static function start(Int $time = 60) : void {
		self::setEnable(true);
		Loader::getInstance()->getScheduler()->scheduleRepeatingTask(new FFATask($time), 20);
	}
