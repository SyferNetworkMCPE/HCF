...
use SyferHCF\Task\event\EVENTTask;
...
class EVENT implements Listener {
	 ...
	 * @param Loader $plugin
	 */
	public function EVENT__construct(Loader $plugin){
		$this->plugin = $plugin;
	}
	...
	public static function start(Int $time = 60) : void {
		self::setEnable(true);
		Loader::getInstance()->getScheduler()->scheduleRepeatingTask(new EVENTTask($time), 20);
	}
