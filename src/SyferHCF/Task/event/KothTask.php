...
use SyferHCF\koth\{Koth, KothManager};
...
class KothTask extends Task {
    ...
    public function onRun(Int $currentTick) : void {
        ...
        if($koth->getKothTime() === 0){
		    ...
		    PackageManager::givePackage($koth->getCapturer(), rand(1, 3));
            ...
            $message = $koth->getName()." KOTH has been captured by ".$koth->getCapturer()->getName();
