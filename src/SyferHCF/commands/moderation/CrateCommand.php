...
use SyferHCF\crate\{Crate, CrateManager};
...
class CrateCommand extends PluginCommand {
	...
	public function __construct(){
		parent::__construct("cr", Loader::getInstance());
		parent::setDescription("management of crates");
	}
	...
	public function execute(CommandSender $sender, String $label, Array $args) : void {
        ...
        switch($args[0]){
			...
			break;
			case "give":
            	if (!$sender->hasPermission("crgive.command.use")) {
					$sender->sendMessage(TE::RED."You have not permissions to use this command");
					return;
				}
