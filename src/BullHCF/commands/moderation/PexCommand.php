...
use BullHCF\provider\MysqlProvider;
...
class PexCommand extends PluginCommand {
	...
	protected $listRanks = ["Guest", "Owner", "Admin", "Jr-Admin", "Sr-Admin", "Mod", "Sr-Mod", "Partner", "MiniYT", "YouTuber", "Famous", "Monster", "VitalHero", "VitalHero+", "Demon", "Angelic", "Streamer", "Developer", "Trainee", "Co-Owner", "NitroBooster"];
