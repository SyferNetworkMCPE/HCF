...
class ReclaimCommand extends PluginCommand {
	...
	public function execute(CommandSender $sender, String $label, Array $args) : void {
		if($sender->getRank() === "Owner"||$sender->getRank() === "Co-Owner"||$sender->getRank() === "Developer"||$sender->getRank() === "Admin"||$sender->getRank() === "Sr-Admin"||$sender->getRank() === "Jr-Admin"||$sender->getRank() === "Sr-Mod"||$sender->getRank() === "Mod"||$sender->getRank() === "Trainee"){
