...
class PlayerBase {
    ...
    public static function create(String $playerName) : void {
        if(!file_exists(Loader::getInstance()->getDataFolder()."players".DIRECTORY_SEPARATOR."{$playerName}.yml")){
            ...
            $config->setAll(["kills" => null, "lives" => null, "lives_claimed" => false, "reclaim" => null, "koth_host" => null, "citadel_host" => null, "brewer" => null,"balance" => null]);
            $config->save();
        }
    }
