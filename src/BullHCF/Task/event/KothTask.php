...
use BullHCF\koth\{Koth, KothManager};
...
class KothTask extends Task {
    ...
    public function onRun(Int $currentTick) : void {
        ...
        if($koth->getKothTime() === 0){
            ...
            CrateManager::giveKey($koth->getCapturer(), "KOTH", 3);
            ...
            Loader::getInstance()->getServer()->getAsyncPool()->submitTask(new DiscordMessage(Loader::getDefaultConfig("URL"), $message, "BullHCF | Koth Information"));
